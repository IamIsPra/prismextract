...
- **Color Count Selection**: Users can choose the number of colors to extract (range: 3–12colors) via a Shadcn Slider or Select dropdown before or after image upload
- **Quantization**: Analyze images to extract the user-specified number of dominant colors
...
| Color Count Selector | Slider or Select | Allows users to choose 3–12 colors; default set to 5 |
...
- **Main Workspace**:
  - Left/Top: Image Upload, Color Count Selector & Palette Extraction
